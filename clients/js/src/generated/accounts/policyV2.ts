...
import { findPolicyV2Pda, PolicyV2Seeds } from '../pdas';
...
export function getPolicyV2Encoder(): FixedSizeEncoder<PolicyV2Args> {
...
export function getPolicyV2Decoder(): FixedSizeDecoder<PolicyV2> {
...
export function getPolicyV2Codec(): FixedSizeCodec<PolicyV2Args, PolicyV2> {
