...
export function getAddIdentityInstructionDataEncoder(): FixedSizeEncoder<AddIdentityInstructionDataArgs> {
...
export function getAddIdentityInstructionDataDecoder(): FixedSizeDecoder<AddIdentityInstructionData> {
...
export function getAddIdentityInstructionDataCodec(): FixedSizeCodec<
...
export type AddIdentityAsyncInput<
...
export async function getAddIdentityInstructionAsync<
  TAccountMint extends string,
  TAccountTokenAccount extends string,
  TAccountPolicy extends string,
  TAccountPayer extends string,
