...
impl RemoveIdentity {
  pub fn instruction(&self, args: RemoveIdentityInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: RemoveIdentityInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = RemoveIdentity {
          ...
          let args = RemoveIdentityInstructionArgs {
                                                              validator_identity: self.validator_identity.clone().expect("validator_identity is not set"),
                                    };
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = RemoveIdentityInstructionArgs {
                                                              validator_identity: self.instruction.validator_identity.clone().expect("validator_identity is not set"),
                                    };
